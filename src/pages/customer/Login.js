  ...
  return (
    <div className="login-container">
      ...
      <i className="login-container-note">
        Đăng nhập để tích điểm và hưởng ưu đãi thành viên khi mua hàng. Nhập số
        điện thoại để tiếp tục đăng nhập hoặc đăng ký thành viên.
      </i>
      ...
      <div className="box-login-fb-gg">
        <button className="btn-login-fb">
          <img
            className="fb-icon"
            src="https://res.cloudinary.com/dhjrrk4pg/image/upload/v1729519358/facebook_2504903_geuvj2.png"
            alt="Facebook Login"
          />
        </button>
        <button className="btn-login-fb">
          <img
            className="fb-icon"
            src="https://res.cloudinary.com/dhjrrk4pg/image/upload/v1729519358/google_2504914_pe1zmv.png"
            alt="Google Login"
          />
        </button>
      </div>
      <p className="item-login-data">
        Bằng việc đăng nhập, bạn đã đồng ý với Điều khoản dịch vụ & chính sách
        bảo mật của Juno
      </p>
