...
const Header = () => {
    // Đọc giá trị cart từ local storage hoặc khởi tạo là false
    ...
    // Lưu giá trị cart vào local storage khi thay đổi
    useEffect(() => {
                            ...
                            <div className="collapse navbar-collapse col-md-11" id="navbarNav">
                                ...
                                <ul className="navbar-nav ml-auto">
                                    ...
                                    <li className="nav-item end-nav">
                                        ...
                                        <div className="nav-link"><img className="user-icon" src="https://res.cloudinary.com/dhjrrk4pg/image/upload/v1729715844/trolley_3743596_qrqu7i.png" onClick={toggleCart} /></div>
                                    </li>
                                </ul>
                            </div>
                        </div>
