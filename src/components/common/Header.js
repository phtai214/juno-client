            ...
            <div className="collapse navbar-collapse col-md-11" id="navbarNav">
              <ul className="navbar-nav ml-auto">
                ...
                <li className="nav-item dropdown ">
                  <Link className="nav-link" to="/customer/product">
                    Sản Phẩm
                  </Link>
                          ...
                          <ul>
                            <li>
                              ...
                              <Link
                                ...
                                to="/customer/product/GIAY/xang-dan"
                              >
                                Giày Xăng Đan
                              </Link>
                            </li>
                            <li>
                              ...
                              <Link
                                className="nav-menu-link-item"
                                to="/customer/product/GIAY/cao-got"
                              >
                                Giày Cao Gót
                              </Link>
                            </li>
                            <li>
                              ...
                              <Link
                                className="nav-menu-link-item"
                                to="/customer/product/GIAY/sneaker"
                              >
                                Giày Sneakers
                              </Link>
                            </li>
                            <li>
                              ...
                              <Link
                                className="nav-menu-link-item"
                                to="/customer/product/GIAY/bup-be"
                              >
                                Giày Búp Bê
                              </Link>
                            </li>
                            <li>
                              ...
                              <Link
                                className="nav-menu-link-item"
                                to="/customer/product/GIAY/dep-guoc"
                              >
                                Dép Guốc
                              </Link>
                            </li>
                        ...
                        <div className="col-md-2 col-sm-2 sub-menu-data">
                          ...
                          <ul>
                            <li>
                              ...
                              <Link
                                className="nav-menu-link-item"
                                to="/customer/product/TUI/xang-dan"
                              >
                                Giày Xăng Đan
                              </Link>
                            </li>
                            <li>
                              ...
                              <Link
                                className="nav-menu-link-item"
                                to="/customer/product/TUI/cao-got"
                              >
                                Giày Cao Gót
                              </Link>
                            </li>
                            <li>
                              ...
                              <Link
                                className="nav-menu-link-item"
                                to="/customer/product/TUI/sneaker"
                              >
                                Giày Sneakers
                              </Link>
                            </li>
                            <li>
                              ...
                              <Link
                                className="nav-menu-link-item"
                                to="/customer/product/TUI/bup-be"
                              >
                                Giày Búp Bê
                              </Link>
                            </li>
                            <li>
                              ...
                              <Link
                                className="nav-menu-link-item"
                                to="/customer/product/TUI/dep-guoc"
                              >
                                Dép Guốc
                              </Link>
                            </li>
                        ...
                        <div className="col-md-2 col-sm-2 sub-menu-data">
                          ...
                          <ul>
                            <li>
                              ...
                              <Link
                                className="nav-menu-link-item"
                                to="/customer/product/PHU-KIEN/xang-dan"
                              >
                                Giày Xăng Đan
                              </Link>
                            </li>
                            <li>
                              ...
                              <Link
                                className="nav-menu-link-item"
                                to="/customer/product/PHU-KIEN/cao-got"
                              >
                                Giày Cao Gót
                              </Link>
                            </li>
                            <li>
                              ...
                              <Link
                                className="nav-menu-link-item"
                                to="/customer/product/PHU-KIEN/sneaker"
                              >
                                Giày Sneakers
                              </Link>
                            </li>
                            <li>
                              ...
                              <Link
                                className="nav-menu-link-item"
                                to="/customer/product/PHU-KIEN/bup-be"
                              >
                                Giày Búp Bê
                              </Link>
                            </li>
                            <li>
                              ...
                              <Link
                                className="nav-menu-link-item"
                                to="/customer/product/PHU-KIEN/dep-guoc"
                              >
                                Dép Guốc
                              </Link>
                            </li>
                        ...
                        <div className="col-md-2 col-sm-2 sub-menu-data">
                          ...
                          <ul>
                            <li>
                              ...
                              <Link
                                className="nav-menu-link-item"
                                to="/customer/product/QUAN-AO/xang-dan"
                              >
                                Giày Xăng Đan
                              </Link>
                            </li>
                            <li>
                              ...
                              <Link
                                className="nav-menu-link-item"
                                to="/customer/product/QUAN-AO/cao-got"
                              >
                                Giày Cao Gót
                              </Link>
                            </li>
                            <li>
                              ...
                              <Link
                                className="nav-menu-link-item"
                                to="/customer/product/QUAN-AO/sneaker"
                              >
                                Giày Sneakers
                              </Link>
                            </li>
                            <li>
                              ...
                              <Link
                                className="nav-menu-link-item"
                                to="/customer/product/QUAN-AO/bup-be"
                              >
                                Giày Búp Bê
                              </Link>
                            </li>
                            <li>
                              ...
                              <Link
                                className="nav-menu-link-item"
                                to="/customer/product/QUAN-AO/dep-guoc"
                              >
                                Dép Guốc
                              </Link>
                            </li>
                        ...
                        <div className="col-md-2 col-sm-2 sub-menu-data">
                          ...
                          <ul>
                            <li>
                              ...
                              <Link
                                className="nav-menu-link-item"
                                to="/customer/product/BST/xang-dan"
                              >
                                Giày Xăng Đan
                              </Link>
                            </li>
                            <li>
                              ...
                              <Link
                                className="nav-menu-link-item"
                                to="/customer/product/BST/cao-got"
                              >
                                Giày Cao Gót
                              </Link>
                            </li>
                            <li>
                              ...
                              <Link
                                className="nav-menu-link-item"
                                to="/customer/product/BST/sneaker"
                              >
                                Giày Sneakers
                              </Link>
                            </li>
                            <li>
                              ...
                              <Link
                                className="nav-menu-link-item"
                                to="/customer/product/BST/bup-be"
                              >
                                Giày Búp Bê
                              </Link>
                            </li>
                            <li>
                              ...
                              <Link
                                className="nav-menu-link-item"
                                to="/customer/product/BST/dep-guoc"
                              >
                                Dép Guốc
                              </Link>
                            </li>
                ...
                <li className="nav-item">
                  <Link className="nav-link hightlight" to="/sale">
                    Quần áo SALE UPTO 50%
                  </Link>
                </li>
                <li className="nav-item">
